...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeResourceTopologyCache)(nil), (*config.NodeResourceTopologyCache)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_NodeResourceTopologyCache_To_config_NodeResourceTopologyCache(a.(*NodeResourceTopologyCache), b.(*config.NodeResourceTopologyCache), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeResourceTopologyCache)(nil), (*NodeResourceTopologyCache)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeResourceTopologyCache_To_v1beta2_NodeResourceTopologyCache(a.(*config.NodeResourceTopologyCache), b.(*NodeResourceTopologyCache), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*SimpleDDLArgs)(nil), (*config.SimpleDDLArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_SimpleDDLArgs_To_config_SimpleDDLArgs(a.(*SimpleDDLArgs), b.(*config.SimpleDDLArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.SimpleDDLArgs)(nil), (*SimpleDDLArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_SimpleDDLArgs_To_v1beta2_SimpleDDLArgs(a.(*config.SimpleDDLArgs), b.(*SimpleDDLArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1beta2_NodeResourceTopologyCache_To_config_NodeResourceTopologyCache is an autogenerated conversion function.
func Convert_v1beta2_NodeResourceTopologyCache_To_config_NodeResourceTopologyCache(in *NodeResourceTopologyCache, out *config.NodeResourceTopologyCache, s conversion.Scope) error {
	return autoConvert_v1beta2_NodeResourceTopologyCache_To_config_NodeResourceTopologyCache(in, out, s)
}
...
// Convert_config_NodeResourceTopologyCache_To_v1beta2_NodeResourceTopologyCache is an autogenerated conversion function.
func Convert_config_NodeResourceTopologyCache_To_v1beta2_NodeResourceTopologyCache(in *config.NodeResourceTopologyCache, out *NodeResourceTopologyCache, s conversion.Scope) error {
	return autoConvert_config_NodeResourceTopologyCache_To_v1beta2_NodeResourceTopologyCache(in, out, s)
}
...
func autoConvert_v1beta2_SimpleDDLArgs_To_config_SimpleDDLArgs(in *SimpleDDLArgs, out *config.SimpleDDLArgs, s conversion.Scope) error {
	return nil
}

// Convert_v1beta2_SimpleDDLArgs_To_config_SimpleDDLArgs is an autogenerated conversion function.
func Convert_v1beta2_SimpleDDLArgs_To_config_SimpleDDLArgs(in *SimpleDDLArgs, out *config.SimpleDDLArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_SimpleDDLArgs_To_config_SimpleDDLArgs(in, out, s)
}

func autoConvert_config_SimpleDDLArgs_To_v1beta2_SimpleDDLArgs(in *config.SimpleDDLArgs, out *SimpleDDLArgs, s conversion.Scope) error {
	return nil
}

// Convert_config_SimpleDDLArgs_To_v1beta2_SimpleDDLArgs is an autogenerated conversion function.
func Convert_config_SimpleDDLArgs_To_v1beta2_SimpleDDLArgs(in *config.SimpleDDLArgs, out *SimpleDDLArgs, s conversion.Scope) error {
	return autoConvert_config_SimpleDDLArgs_To_v1beta2_SimpleDDLArgs(in, out, s)
}
